...
if((_vehicle isKindOf "Car") || !(_vehicle isKindOf "Air") || !(_vehicle isKindOf "Ship")) then
{
	...
	if(isNil {_owners}) exitWith {hint localize "STR_NOTF_VehCheat"; diag_log format ["Vehiculo follado _vehicle: %1, _owners: %2", _vehicle, _owners];/*deleteVehicle _vehicle;*/};
