...
switch (_vehicle) do
{
	case "C_Offroad_01_F" :
	{
		switch (_index) do
		{
			...
			case 6: {_color = "Black"};
			case 7: {_color = "Oculto 2"};
			case 8: {_color = "Taxi"};
			case 9: {_color = "Oculto"};
			case 9: {_color = "Nacional"};
			case 10: {_color = "Guardia Civil"};
			case 11: {_color = "Geo"};
			case 12: {_color = "Local"};
			case 13: {_color = "Medico"};
		};
	};
	...
	case "C_SUV_01_F":
	{
		switch (_index) do
		{
			...
			case 6: {_color = "Nacional";};
			case 7: {_color = "Medico";};
		};
	};
	...
	case "B_Heli_Light_01_F":
	{
		switch (_index) do
		{
			...
			case 15: {_color = "Nacional"};
			case 16: {_color = "Medico"};
		};
	};
