...
switch (_side) do {
	...
	case civilian: {_query = format["UPDATE players SET name='%1', cash='%2', bankacc='%3', civ_licenses='%4', civ_gear='%6', arrested='%7', civPosition='%8', alive='%9' WHERE playerid='%5'",_name,_cash,_bank,_licenses,_uid,_gear,_civPosition,[_this select 9] call DB_fnc_bool];};
