...
if(!((player distance (getMarkerPos "cop_spawn_1") < 60) OR  (player distance (getMarkerPos "cop_spawn_4") < 50) OR (player distance (getMarkerPos "cop_spawn_3") < 30) OR (player distance (getMarkerPos "copeast_spawn_1") < 60) OR  (player distance (getMarkerPos "copeast_spawn_2") < 50) )) then
{
