...
_resourceZones = ["apple_1","apple_2","apple_3","apple_4","peaches_1","peaches_2","peaches_3","peaches_4","heroin_1","cocaine_1","weed_1","lead_1","iron_1","iron_1_1","salt_1","salt_1_1","sand_1","sand_1_1","diamond_1","diamond_1_1","diamond_1_1_1","oil_1","oil_2","rock_1","rock_1_1"];
_zone = "";
...
_item = switch(true) do {
	...
	case (_zone in ["iron_1","iron_1_1"]): {"ironore"};
	case (_zone in ["salt_1","salt_1_1"]): {"salt"};
	case (_zone in ["sand_1", "sand_1_1"]): {"sand"};
	case (_zone in ["diamond_1","diamond_1_1","diamond_1_1_1"]): {"diamond"};
	case (_zone in ["oil_1","oil_2","oil_2_1","oil_2_2"]): {"oilu"};
	case (_zone in ["rock_1","rock_1_1"]): {"rock"};
	default {""};
};
