...
if((_vehicle isKindOf "Car") || (_vehicle isKindOf "Air") || (_vehicle isKindOf "Ship")) then
{
	...
	// COMPROBAR BUG DE DESAPARECER LOS COCHES
	if(count _vehicleData == 0) exitWith {diag_log format ["Vehiculo follado impound _vehicle: %1, _vehicleData: %2", _vehicle, _vehicleData];/*deleteVehicle _vehicle;*/}; //Bad vehicle.
