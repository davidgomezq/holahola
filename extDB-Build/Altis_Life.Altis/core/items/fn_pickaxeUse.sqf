...
switch (true) do
{
	...
	case (player distance (getMarkerPos "iron_1_1") < 30): {_mine = "ironore"; _val = 2;};

	//Sal
	case (player distance (getMarkerPos "salt_1") < 120) : {_mine = "salt"; _val = 4;};
	case (player distance (getMarkerPos "salt_1_1") < 120) : {_mine = "salt"; _val = 4;};

	//Arena
	case (player distance (getMarkerPos "sand_1") < 75) : {_mine = "sand"; _val = 5;};
	case (player distance (getMarkerPos "sand_1_1") < 75) : {_mine = "sand"; _val = 5;};

	//DIAMANTES
	case (player distance (getMarkerPos "diamond_1") < 50): {_mine = "diamond"; _val = 1;};
	case (player distance (getMarkerPos "diamond_1_1") < 50): {_mine = "diamond"; _val = 1;};
	case (player distance (getMarkerPos "diamond_1_1_1") < 50): {_mine = "diamond"; _val = 1;};

	//Petroleo
	case (player distance (getMarkerPos "oil_1") < 40) : {_mine = "oilu"; _val = 1;};
	case (player distance (getMarkerPos "oil_2") < 40) : {_mine = "oilu"; _val = 1;};
	case (player distance (getMarkerPos "oil_2_1") < 40) : {_mine = "oilu"; _val = 1;};
	case (player distance (getMarkerPos "oil_2_2") < 40) : {_mine = "oilu"; _val = 1;};


	//Piedra
	case (player distance (getMarkerPos "rock_1") < 50): {_mine = "rock"; _val = 2;};
	case (player distance (getMarkerPos "rock_1_1") < 50): {_mine = "rock"; _val = 2;};
