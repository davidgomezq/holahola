...
class CfgFunctions
{
	...
	class TON_System
	{
		...
		class TPLP
		{
			file = "\life_server\Functions\TPLP";
		...
		class RandomEvent
		{
			file = "\life_server\Functions\TPLP\RandomEvents";
			class spawnHeliCrash {}; // Mapa dinamico: Spawn accidentes de helicopteros
			class spawnNaufragios {}; // Mapa dinamico: Spawn naufragios
		};
	};	
};
